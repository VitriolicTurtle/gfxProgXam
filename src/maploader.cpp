...
MapLoader::MapLoader(){
	...
	models.push_back({ "resources/Objects/Duck/12248_Bird_v1_L2.obj", "resources/Objects/Duck/12248_Bird_v1_diff.png", glm::vec3(4, -50, 22), glm::vec3(0.2, 0.2, 0.2), false, -40, 190.0 });

	//		SECOND MODEL: Fish
	objModelVector.push_back({});
	models.push_back({ "resources/Objects/Fish/fish.obj", "resources/Objects/Fish/fish.png", glm::vec3(4, -52, 27), glm::vec3(1.0, 1.0, 1.0), false, -55, 0.0 });
